...
//
// The backend already resolves the most common protocols (ANY/ICMP/TCP/UDP/
// ICMPv6) to names; anything else arrives as a bare number string (e.g. "2"
// for IGMP). getProtocolName() resolves those remaining numbers to names while
// passing already-named values through unchanged.
